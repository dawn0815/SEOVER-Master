...
from models import BiE2EModel,BiModel, Model, MaskedNLLLoss
from dataload import MELDDataset
...
train_loader, valid_loader, test_loader = \
    get_MELD_loaders('./MELD.pkl', n_classes,
                     valid=0.0,
                     batch_size=batch_size,
                     num_workers=0)
...
array=[]
array=confusion_matrix(best_label, best_pred)
